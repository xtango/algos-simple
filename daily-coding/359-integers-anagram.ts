 ...
 * of 'threefiveseven'. Note that there can be multiple instances of 
 * each integer. Given this string, return the original integers in sorted
 * order. In the example above, this would be 357.
 */
...
/**
 * Returns a new array of a[i] - b[i], where a and b are frequency arrays.
 */
