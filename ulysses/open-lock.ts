 ...
 *                        OPEN THE LOCK
 *
 * Problem statement: https://leetcode.com/problems/open-the-lock/description/
 */

/**
 * Bi-directional BFS. Faster for large N, but more complicated.
 * We use 2 queues. We start with q1 initialized to '0000' and q2 initialized to the target.
 * See video: https://www.youtube.com/watch?v=a_uRLWLI5ug
 */
